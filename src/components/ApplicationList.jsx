    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {applications.map((application) => (
          <div
            key={application._id}
            className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow hover:shadow-lg transition-all duration-300"
          >
            ...
            <div className="p-5">
              <div className="flex flex-col space-y-3 text-sm text-gray-700 mb-4">
